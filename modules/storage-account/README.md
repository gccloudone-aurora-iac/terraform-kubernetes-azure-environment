...
Vendored from [`terraform-azure-storage-account`](https://github.com/gccloudone-aurora-iac/terraform-azure-storage-account) at `v2.0.2`. See [../VENDOR.md](../VENDOR.md) for provenance and the re-sync procedure.
