...
Vendored from [`terraform-aurora-azure-environment-network`](https://github.com/gccloudone-aurora-iac/terraform-aurora-azure-environment-network) at `v2.0.1`. See [../VENDOR.md](../VENDOR.md) for provenance and the re-sync procedure.
