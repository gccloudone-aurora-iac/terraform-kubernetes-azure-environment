...
Vendored from [`terraform-azure-kubernetes-cluster-nodepool`](https://github.com/gccloudone-aurora-iac/terraform-azure-kubernetes-cluster-nodepool) at `v2.0.2`. See [../VENDOR.md](../VENDOR.md) for provenance and the re-sync procedure.
