...
Vendored from [`terraform-azure-virtual-network`](https://github.com/gccloudone-aurora-iac/terraform-azure-virtual-network) at `v2.0.1`. See [../VENDOR.md](../VENDOR.md) for provenance and the re-sync procedure.
