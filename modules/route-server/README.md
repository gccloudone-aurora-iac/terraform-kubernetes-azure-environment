...
Vendored from [`terraform-azure-route-server`](https://github.com/gccloudone-aurora-iac/terraform-azure-route-server) at `v2.0.1`. See [../VENDOR.md](../VENDOR.md) for provenance and the re-sync procedure.
