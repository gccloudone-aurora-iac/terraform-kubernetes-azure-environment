...
Vendored from [`terraform-azure-key-vault`](https://github.com/gccloudone-aurora-iac/terraform-azure-key-vault) at `v2.0.1`. See [../VENDOR.md](../VENDOR.md) for provenance and the re-sync procedure.
