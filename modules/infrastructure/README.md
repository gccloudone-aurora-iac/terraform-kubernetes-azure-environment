...
Vendored from [`terraform-aurora-azure-environment-infrastructure`](https://github.com/gccloudone-aurora-iac/terraform-aurora-azure-environment-infrastructure) at `v3.0.0`. See [../VENDOR.md](../VENDOR.md) for provenance and the re-sync procedure.
