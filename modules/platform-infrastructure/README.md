...
Vendored from [`terraform-aurora-azure-environment-platform-infrastructure`](https://github.com/gccloudone-aurora-iac/terraform-aurora-azure-environment-platform-infrastructure) at `v3.3.2`. See [../VENDOR.md](../VENDOR.md) for provenance and the re-sync procedure.
