...
Vendored from [`terraform-azure-kubernetes-cluster`](https://github.com/gccloudone-aurora-iac/terraform-azure-kubernetes-cluster) at `v3.0.0`. See [../VENDOR.md](../VENDOR.md) for provenance and the re-sync procedure.
